class DropBoxController {
    ...
    constructor() {
        ...
        this.onChangeSelection = new Event('changeselection');
    ...
    connectFirebase() {
        var firebaseConfig = {
            apiKey: "AIzaSyBDQQecBUWj708O6Q5uh8W12BD-5PPd4Ak",
            authDomain: "dropbox-clone-7050.firebaseapp.com",
            databaseURL: "https://dropbox-clone-7050.firebaseio.com",
            projectId: "dropbox-clone-7050",
            storageBucket: "dropbox-clone-7050.appspot.com",
            messagingSenderId: "185963874269",
            appId: "1:185963874269:web:a650ed7f23e93a7a13d834",
            measurementId: "G-7EEW0ZTT69"
        };
        // Initialize Firebase
    ...
    removeFolderTask(ref, folderName) {

        return new Promise((resolve, reject) => {

            let folderRef = this.getFireBaseRef(ref + "/" + folderName);
            ...
            folderRef.on('value', snapshot => {
                ...
                snapshot.forEach(item => {
                    ...
                    if (data.type === 'folder') {
                        ...
                        this.removeFolderTask(ref + "/" + folderName, data.name).then(() => {
                            resolve({
                                fields: {
                                    key: data.key
                                }
                        ...
                        this.removeFile(ref + "/" + folderName, data.name).then(() => {
                            resolve({
                                fields: {
                                    key: data.key
                                }
    ...
    initEvents() {
        ...
        this.btnNewFolder.addEventListener('click', event => {
            ...
            let name = prompt('How should we call this folder?');
        ...
        this.listFilesEl.addEventListener('changeselection', event => {
    ...
    ajaxTask(method = 'GET', url, formData = new FormData(), onprogress = function () { }, onloadstart = function () { }) {
        ...
        li.addEventListener('click', e => {
            ...
            if (e.shiftKey) {
                ...
                if (firstLi) {
                    ...
                    this.listFilesEl.dispatchEvent(this.onChangeSelection);
                    return true;
